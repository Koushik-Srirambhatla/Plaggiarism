...
def search_google_snippet(query):
    params = {
        "q": query,
        "api_key": "0bfdb56d51fdcc082ff90bf916b2037e4ab31b02875b2dfe1d355e4920d7c414",  # <<< Make sure you use your key
        "engine": "google",
        "num": "3"
    }
    try:
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            for f in os.listdir(UPLOAD_FOLDER):
                other_path = os.path.join(app.config['UPLOAD_FOLDER'], f)
...
# --- Handle text entered into textbox ---
